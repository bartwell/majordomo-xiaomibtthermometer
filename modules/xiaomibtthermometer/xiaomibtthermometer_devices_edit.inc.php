...
*/
  ...
  $table_name='xiaomibtthermometer_devices';
  ...
  //updating '<%LANG_LINKED_OBJECT%>' (varchar)
   $rec['LINKED_OBJECT_TEMPERATURE']=gr('linked_object_temperature');
  //updating '<%LANG_LINKED_PROPERTY%>' (varchar)
   $rec['LINKED_PROPERTY_TEMPERATURE']=gr('linked_property_temperature');
  //updating '<%LANG_LINKED_OBJECT%>' (varchar)
   $rec['LINKED_OBJECT_HUMIDITY']=gr('linked_object_humidity');
  //updating '<%LANG_LINKED_PROPERTY%>' (varchar)
   $rec['LINKED_PROPERTY_HUMIDITY']=gr('linked_property_humidity');
  //UPDATING RECORD
   if ($ok) {
    if ($rec['ID']) {
